    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Y.N.K logos consulting & Services Ltd משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '4e5a31cd-67d7-4b0e-9781-bd55870644e0',
                    name: data.name || '',
                    email: data.email || '',
